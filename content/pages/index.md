...
sections:
  - type: GenericSection
    ...
    actions:
      ...
      - label: How I Can Help
        ...
        type: Link
    media:
      url: /images/seerose.jpg
      altText: Peaceful natural setting — water lily pond
      type: ImageBlock
    badge:
    ...
    title:
      ...
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: Areas of Specialisation
    items:
      - type: FeaturedItem
        icon: 🌱
  ...
  - type: GenericSection
    title:
      text: A Space to Be Seen, Heard, and *Accepted*
      color: text-dark
      type: TitleBlock
  ...
  - type: GenericSection
    title:
      text: Counselling in French & English
      color: text-dark
      styles:
        self:
          textAlign: center
  ...
  - type: GenericSection
    title:
      text: Take the First Step Towards *Lasting Wellbeing*
      color: text-light
      styles:
        self:
          textAlign: center
